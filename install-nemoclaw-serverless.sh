...
# =============================================================================
# Deploys NemoClaw (OpenClaw + NemoClaw plugin) as a serverless endpoint on
# Nebius cpu-e2 (Intel Ice Lake). No GPU needed — inference is routed to
...
#   INFERENCE_MODEL - Model for inference (default: deepseek-ai/DeepSeek-R1-0528)
...
ENDPOINT_NAME="nemoclaw-serverless"
PLATFORM="cpu-e2"
CONTAINER_PORT=8080
