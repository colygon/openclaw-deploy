...
function showDemoBanner() {
  ...
  ghLink.href = 'https://github.com/colygon/openclaw-deploy/issues';
  ghLink.target = '_blank';
  ghLink.rel = 'noopener';
  ghLink.textContent = 'GitHub';
  ghLink.style.cssText = 'color:inherit;text-decoration:underline';
  bannerText.append('🦞 ', bold, ' — This is an open source community project and is not operated by Nebius. We do not offer any support for this website. Please report any issues on our ');
  bannerText.appendChild(ghLink);
  bannerText.append('. To deploy real endpoints, run locally:');
